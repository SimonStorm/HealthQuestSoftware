...
if($_SERVER['REQUEST_METHOD'] == 'PUT')
{
         ...
         */
        //log_error("Script name = " . $_SERVER["PHP_SELF"]);
...
{
        /*
         * With PUT the filename is in the query string.
         */
...
if(isset($_REQUEST['userfile_parent']))
{
        ...
        */
        //error_log('Fname before replace with userfile_parent ' . $fname);
...
if(isset($_REQUEST['cmd']))
{
    ...
    switch ($cmd)
    {
        ...
        case 2:
            ...
            */
            //log_error('SAVING: userfile_parent=' .$userfile_parent);
...
else
{
    if($fname != '')
    {
        ...
        error_log($_SERVER["Content-Length"]);
