...
my $DATA_DIR = '/home/storm/public_html/healthquestsoftware/';   # Path of data directory
my $DEFAULT_UPLOAD_DIR = '/home/storm/public_html/healthquestsoftware/tmp/'; #used only if you don't use password.

my $MAX_SIZE_UPLOAD = 3000; # Ko
	# File sizes are limited to $MAX_SIZE_UPLOAD (0 No limit), larger files will
	# return an 'Internal Server Error'.

my $FORM_URL = 'http://www.healthquestsoftware.com/upload.html';

my $WEBMASTER_EMAIL = 'simon@simonstorm.com';
...
if ($DISPLAY_LANG eq 'Fr') {
	...
	%NAME_HEADTAB = ('name' => 'Name', 'level' => 'Level', 'user_path' => "User path",
		...
		'admin' => 'Administrator', 'member' => 'Member', 'w_path' => "(Path doesn't exist !)");
